    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="mb-6 border-b border-gray-200">
            <nav class="-mb-px flex space-x-6" aria-label="Tabs">
                ...
                >
                    <svg class="{{ $activeTab === 'overview' ? 'text-indigo-600' : 'text-gray-400' }} mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                >
                    <svg class="{{ $activeTab === 'users' ? 'text-indigo-600' : 'text-gray-400' }} mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
